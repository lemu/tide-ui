...
export const GroupingWithActiveRowAndFilters: Story = {
  name: 'Grouping Rows - Active Row with External Filters',
  parameters: {
    layout: 'fullscreen',
    docs: {
      description: {
        story: `Demonstrates active row highlighting combined with external filtering in a grouped DataTable.

## Features

- **Active Row Highlighting**: Click any row to highlight it with the built-in \`activeRowId\` prop
- **External Filters**: Status, Vessel, and Counterparty filters managed via Filters component
- **Tag-Based Search**: Global search with search terms displayed as tags
- **Custom Highlighting**: Yellow highlighting for search matches in both regular and aggregated cells
- **Group-Preserving**: Maintains grouping structure during filtering and search
