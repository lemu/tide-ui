  ...
  render: () => {
    ...
    return (
      <div className="w-96 p-4">
        ...
        >
          <EditablePreview className="cursor-pointer hover:bg-[var(--color-background-neutral-subtlest-hovered)] p-2 rounded-[var(--border-radius-m)] transition-colors" />
          <EditableInput className="border-2 border-[var(--color-border-brand-bold)] p-2 rounded-[var(--border-radius-m)] outline-none" />
        </Editable>
      </div>
    )
  },
  ...
  render: () => {
    ...
    return (
      <div className="w-full p-4">
        ...
        >
          <EditablePreview
            className="text-heading-lg cursor-pointer hover:bg-[var(--color-background-neutral-subtlest-hovered)] rounded-[var(--border-radius-m)] transition-colors"
            style={{
              ...sharedStyles,
              minHeight: '3rem',
              display: 'flex',
          ...
          />
          <EditableInput
            className="text-heading-lg bg-transparent border-none outline-none focus:ring-2 focus:ring-[var(--color-border-brand-bold)] rounded-[var(--border-radius-m)]"
            style={sharedStyles}
            autoResize
            minWidth={200}
            charWidth={20}
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-2xl p-4">
        ...
        >
          <EditablePreview
            className="cursor-pointer hover:bg-[var(--color-background-neutral-subtlest-hovered)] rounded-[var(--border-radius-m)] transition-colors"
            style={{
              ...sharedStyles,
              minHeight: '2rem',
              display: 'flex',
          ...
          />
          <EditableInput
            className="bg-transparent border-none outline-none focus:ring-2 focus:ring-[var(--color-border-brand-bold)] rounded-[var(--border-radius-m)]"
            style={sharedStyles}
            autoResize
            minWidth={150}
            charWidth={12}
    ...
    return (
      <div className="w-full max-w-2xl p-4 space-y-6">
        <div>
          ...
          <div className="border border-[var(--color-border-primary-subtle)] rounded-[var(--border-radius-l)] p-4">
            <Editable
            ...
            >
              <EditablePreview className="text-body-md cursor-pointer hover:bg-[var(--color-background-neutral-subtlest-hovered)] p-2 rounded-[var(--border-radius-m)] transition-colors" />
              <EditableInput className="text-body-md border-2 border-[var(--color-border-brand-bold)] p-2 rounded-[var(--border-radius-m)] outline-none" />
            </Editable>
  ...
  render: () => {
    return (
      <div className="w-96 p-4">
        ...
        <div className="border border-[var(--color-border-primary-subtle)] rounded-[var(--border-radius-l)] p-4 bg-[var(--color-surface-secondary)]">
          <Editable
          ...
          >
            <EditablePreview
              className="text-body-md rounded-[var(--border-radius-m)] p-2"
              style={{
            ...
            />
            <EditableInput
              className="text-body-md p-2 rounded-[var(--border-radius-m)]"
              style={{
                color: 'var(--color-text-disabled)',
  ...
  render: () => {
    ...
    return (
      <div className="w-full max-w-xl p-4">
        ...
        >
          <EditablePreview
            className="cursor-pointer rounded-[var(--border-radius-l)] transition-all duration-200 hover:shadow-[var(--shadow-200)]"
            style={{
          ...
          />
          <EditableInput
            className="rounded-[var(--border-radius-l)] outline-none transition-all duration-200"
            style={{
              color: 'var(--color-text-brand-bold)',
              fontSize: 'var(--font-size-500)',
              lineHeight: 'var(--font-line-height-600)',
              ...
              boxShadow: 'var(--shadow-[var(--shadow-300)])',
            }}
            autoResize
            charWidth={14}
          />
        ...
        <div className="space-y-4">
          <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="border border-[var(--color-border-success-bold)] rounded-[var(--border-radius-l)] p-4 bg-[var(--color-background-success-subtle)]">
              ...
              <div className="border border-[var(--color-border-info-bold)] rounded-[var(--border-radius-l)] p-4 bg-[var(--color-background-info-subtle)]">
              ...
              <div className="border border-[var(--color-border-brand-bold)] rounded-[var(--border-radius-l)] p-4 bg-[var(--color-background-blue-subtle-selected)]">
          ...
          <div className="bg-[var(--color-surface-secondary)] rounded-[var(--border-radius-l)] p-4">
