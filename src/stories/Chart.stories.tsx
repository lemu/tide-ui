...
export const RoundedYAxis: Story = {
  render: () => (
    <div className="w-full max-w-7xl mx-auto p-[var(--space-lg)] space-y-[var(--space-xlg)]">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-[var(--space-xlg)]">
        ...
        <div className="bg-[var(--color-surface-primary)] border border-[var(--color-border-primary-subtle)] p-[var(--space-lg)] rounded-lg">
          <h3 className="text-heading-md mb-[var(--space-md)]">Default (roundYAxis=false)</h3>
          <p className="text-body-sm text-[var(--color-text-secondary)] mb-[var(--space-md)]">
            Y-axis may show decimal values and inconsistent intervals
          </p>
          <Chart
            type="line"
            data={[
              { name: 'Jan', value: 350, sales: 280 },
              { name: 'Feb', value: 420, sales: 390 },
              { name: 'Mar', value: 280, sales: 320 },
              { name: 'Apr', value: 550, sales: 480 },
              { name: 'May', value: 370, sales: 340 },
            ]}
            config={createChartConfig({
              value: { label: 'Revenue', color: 'var(--color-chart-line-1)' },
              sales: { label: 'Sales', color: 'var(--color-chart-line-2)' },
        ...
        {/* With Rounding */}
        <div className="bg-[var(--color-surface-primary)] border border-[var(--color-border-primary-subtle)] p-[var(--space-lg)] rounded-lg">
          <h3 className="text-heading-md mb-[var(--space-md)]">Rounded (roundYAxis=true)</h3>
          <p className="text-body-sm text-[var(--color-text-secondary)] mb-[var(--space-md)]">
            Y-axis shows clean rounded values with consistent intervals
          </p>
          <Chart
            type="line"
            data={[
      ...
      <div className="bg-[var(--color-surface-primary)] border border-[var(--color-border-primary-subtle)] p-[var(--space-lg)] rounded-lg">
        <h3 className="text-heading-md mb-[var(--space-md)]">With Different Tick Counts</h3>
        <p className="text-body-sm text-[var(--color-text-secondary)] mb-[var(--space-md)]">
          roundYAxis works with any yAxisTickCount value
        </p>
        <div className="grid grid-cols-3 gap-4">
          <div>
            <h4 className="text-body-strong-sm mb-2">4 Ticks</h4>
            <Chart
              type="bar"
              data={[
                { name: 'A', value: 385 },
          ...
          <div>
            <h4 className="text-body-strong-sm mb-2">6 Ticks</h4>
            <Chart
              type="bar"
              data={[
                { name: 'A', value: 385 },
          ...
          <div>
            <h4 className="text-body-strong-sm mb-2">8 Ticks</h4>
            <Chart
              type="bar"
              data={[
                { name: 'A', value: 385 },
