        ...
        <div className="grid grid-cols-1 gap-[var(--space-lg)] md:grid-cols-2">
            ...
            <CardContent>
              <div className="space-y-[var(--space-md)]">
                ...
                <div className="space-y-[var(--space-sm)]">
                  ...
                  <TextLink href="#" disabled icon="link">
                    Disabled with icon
                  </TextLink>
                </div>
              </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="space-y-[var(--space-md)]">
                <div className="flex items-center space-x-[var(--space-md)]">
                  <TextLink href="#" variant="subtle" size="sm">
                    Small subtle
                  </TextLink>
                  <TextLink href="#" variant="subtle" size="md">
                    Medium subtle
                  </TextLink>
                  <TextLink href="#" variant="subtle" size="lg">
                    Large subtle
                  </TextLink>
                </div>
                <div className="space-y-[var(--space-sm)]">
                  ...
                  <TextLink href="#" variant="subtle" disabled icon="settings">
                    Disabled subtle with icon
                  </TextLink>
                </div>
              </div>
            </CardContent>
            ...
            <CardContent>
              <div className="space-y-[var(--space-sm)]">
                ...
                <p className="text-caption-sm text-[var(--color-text-secondary)]">
                  Links automatically receive focus outlines and proper ARIA
                  attributes.
                </p>
              </div>
            </CardContent>
      ...
      <section>
        ...
        <Card>
          ...
          <CardContent>
            <div className="grid grid-cols-1 gap-[var(--space-lg)] md:grid-cols-2">
              <div>
                <h4 className="text-body-medium-md mb-[var(--space-sm)] text-[var(--color-text-brand)]">
                  Default Links
                </h4>
              ...
              <div>
                <h4 className="text-body-medium-md mb-[var(--space-sm)] text-[var(--color-text-secondary)]">
                  Subtle Links
                </h4>
                <ul className="text-body-sm space-y-[var(--space-xsm)] text-[var(--color-text-secondary)]">
