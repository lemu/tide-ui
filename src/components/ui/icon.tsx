  ...
  "chart-dashline": (
    <g>
      <g>
        ...
        <path d="M2.4 9.6H6V14.4H2.4V9.6Z" fill="currentColor" />
        <path d="M8.4 9.6H14.4V14.4H8.4V9.6Z" fill="currentColor" />
      </g>
    </g>
  ),
  "chart-dashline-2": (
    <g>
      <g>
        ...
        <path d="M2.4 9.6H10V14.4H2.4V9.6Z" fill="currentColor" />
      </g>
    </g>
  ),
  "chart-dotline": (
  ...
  "ship-unload": (
    <g>
      <g>
        <path
          clipRule="evenodd"
          d="M11.9996 1C12.5519 1 12.9996 1.44772 12.9996 2V4H16.9996C17.7953 4 18.5591 4.3163 19.1217 4.87891C19.6841 5.44148 19.9996 6.2045 19.9996 7V12.46L21.4059 13.0859C21.7644 13.2453 21.9966 13.5999 21.9996 13.9922C22.0168 16.2842 21.4083 18.5379 20.2399 20.5098C19.9583 20.9847 19.3448 21.1418 18.8698 20.8604C18.3949 20.5787 18.2387 19.9653 18.5202 19.4902C19.3947 18.0142 19.8962 16.3505 19.986 14.6436L11.9996 11.0938L4.0143 14.6436C4.10409 16.3506 4.60653 18.0142 5.48109 19.4902C5.76231 19.9652 5.60528 20.5788 5.13051 20.8604C4.65546 21.1418 4.042 20.9847 3.76039 20.5098C2.59201 18.5379 1.98348 16.2842 2.00062 13.9922C2.00369 13.5999 2.23583 13.2453 2.59437 13.0859L3.99965 12.4609V7C3.99965 6.20443 4.31605 5.4415 4.87855 4.87891C5.44109 4.31637 6.20412 4.00009 6.99965 4H10.9996V2C10.9996 1.44782 11.4475 1.00018 11.9996 1ZM6.99965 6C6.73455 6.00009 6.48008 6.10551 6.29262 6.29297C6.10518 6.48049 5.99965 6.73486 5.99965 7V11.5723L11.528 9.11523C11.5497 9.10554 11.5716 9.09564 11.5934 9.08594C11.7226 9.02855 11.8614 9.00005 11.9996 9C12.1383 8.99991 12.2774 9.0284 12.4069 9.08594C12.4267 9.09476 12.4466 9.10349 12.4664 9.1123L17.9996 11.5713V7C17.9996 6.73478 17.8942 6.48051 17.7067 6.29297C17.5192 6.10553 17.2648 6 16.9996 6H6.99965Z"
          fill="currentColor"
          fillRule="evenodd"
        />
        <path
...
const Icon = React.forwardRef<SVGSVGElement, IconProps>(
  ({ name, size = "md", color = "primary", className, ...props }, ref) => {
