...
>(({ className, value, defaultValue, ...props }, ref) => {
  ...
  return (
    <SliderPrimitive.Root
      ...
      {...props}
    >
      <SliderPrimitive.Track className="relative h-[var(--size-3xs)] w-full grow overflow-hidden rounded-full bg-[var(--color-background-neutral-default)] data-[disabled]:!cursor-not-allowed z-0">
